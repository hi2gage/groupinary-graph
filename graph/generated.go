...
func (ec *executionContext) unmarshalInputCreateWordInput(ctx context.Context, obj interface{}) (ent.CreateWordInput, error) {
	...
	fieldsInOrder := [...]string{"description", "creatorID", "definitionIDs", "descendantIDs", "parentID"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputWordWhereInput(ctx context.Context, obj interface{}) (ent.WordWhereInput, error) {
	...
	fieldsInOrder := [...]string{"not", "and", "or", "id", "idNEQ", "idIn", "idNotIn", "idGT", "idGTE", "idLT", "idLTE", "description", "descriptionNEQ", "descriptionIn", "descriptionNotIn", "descriptionGT", "descriptionGTE", "descriptionLT", "descriptionLTE", "descriptionContains", "descriptionHasPrefix", "descriptionHasSuffix", "descriptionEqualFold", "descriptionContainsFold", "hasCreator", "hasCreatorWith", "hasDefinitions", "hasDefinitionsWith", "hasDescendants", "hasDescendantsWith", "hasParent", "hasParentWith"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
