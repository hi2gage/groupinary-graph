...
func (ec *executionContext) unmarshalInputCreateWordInput(ctx context.Context, obj interface{}) (ent.CreateWordInput, error) {
	...
	fieldsInOrder := [...]string{"description", "descendantcount", "creatorID", "groupID", "definitionIDs", "descendantIDs", "parentIDs"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputUpdateGroupInput(ctx context.Context, obj interface{}) (ent.UpdateGroupInput, error) {
	...
	fieldsInOrder := [...]string{"description", "addRootWordIDs", "removeRootWordIDs", "clearRootWords", "addUserIDs", "removeUserIDs", "clearUsers"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputUpdateWordInput(ctx context.Context, obj interface{}) (ent.UpdateWordInput, error) {
	...
	fieldsInOrder := [...]string{"description", "groupID", "clearGroup", "addParentIDs", "removeParentIDs", "clearParents"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
