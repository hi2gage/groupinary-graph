...
func (ec *executionContext) unmarshalInputWordWhereInput(ctx context.Context, obj interface{}) (ent.WordWhereInput, error) {
	...
	fieldsInOrder := [...]string{"not", "and", "or", "id", "idNEQ", "idIn", "idNotIn", "idGT", "idGTE", "idLT", "idLTE", "description", "descriptionNEQ", "descriptionIn", "descriptionNotIn", "descriptionGT", "descriptionGTE", "descriptionLT", "descriptionLTE", "descriptionContains", "descriptionHasPrefix", "descriptionHasSuffix", "descriptionEqualFold", "descriptionContainsFold", "root", "rootNEQ", "hasCreator", "hasCreatorWith", "hasDefinitions", "hasDefinitionsWith", "hasDescendants", "hasDescendantsWith", "hasParent", "hasParentWith"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
